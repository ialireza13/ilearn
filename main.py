...
train_images, train_labels = read_hoda_cdb('./samples-FA/Train 60000.cdb')
...
test_images, test_labels = read_hoda_cdb('./samples-FA/Test 20000.cdb')
...
remaining_images, remaining_labels = read_hoda_cdb('./samples-FA/RemainingSamples.cdb')
...
X_train, Y_train = read_hoda_dataset(dataset_path='./samples-FA/Train 60000.cdb',
                                images_height=32,
                                images_width=32,
                                one_hot=False,
                                reshape=False)
...
X_test, Y_test = read_hoda_dataset(dataset_path='./samples-FA/Test 20000.cdb',
                              images_height=32,
                              images_width=32,
                              one_hot=True,
                              reshape=False)
...
X_remaining, Y_remaining = read_hoda_dataset('./samples-FA/RemainingSamples.cdb',
                                             images_height=32,
                                             images_width=32,
                                             one_hot=True,
                                             reshape=True)
